...
public class IaIvrServiceLocator extends org.apache.axis.client.Service implements Eai.IAcquirer.Ctcb.IaIvrService {
    ...
    public Eai.IAcquirer.Ctcb.ServiceName getBasicHttpBinding_ServiceName() throws javax.xml.rpc.ServiceException {
    ...
    public Eai.IAcquirer.Ctcb.ServiceName getBasicHttpBinding_ServiceName(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Eai.IAcquirer.Ctcb.BasicHttpBinding_ServiceNameStub _stub = new Eai.IAcquirer.Ctcb.BasicHttpBinding_ServiceNameStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Eai.IAcquirer.Ctcb.ServiceName.class.isAssignableFrom(serviceEndpointInterface)) {
                Eai.IAcquirer.Ctcb.BasicHttpBinding_ServiceNameStub _stub = new Eai.IAcquirer.Ctcb.BasicHttpBinding_ServiceNameStub(new java.net.URL(BasicHttpBinding_ServiceName_address), this);
                _stub.setPortName(getBasicHttpBinding_ServiceNameWSDDServiceName());
                return _stub;
            }
        }
