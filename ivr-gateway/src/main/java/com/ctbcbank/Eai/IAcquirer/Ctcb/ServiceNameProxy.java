...
public class ServiceNameProxy implements com.ctbcbank.Eai.IAcquirer.Ctcb.ServiceName {
  private String _endpoint = null;
  private com.ctbcbank.Eai.IAcquirer.Ctcb.ServiceName serviceName = null;
  ...
  private void _initServiceNameProxy() {
    try {
      serviceName = (new com.ctbcbank.Eai.IAcquirer.Ctcb.IaIvrServiceLocator()).getBasicHttpBinding_ServiceName();
      if (serviceName != null) {
        if (_endpoint != null)
  ...
  public com.ctbcbank.Eai.IAcquirer.Ctcb.ServiceName getServiceName() {
    if (serviceName == null)
      _initServiceNameProxy();
    return serviceName;
  }
