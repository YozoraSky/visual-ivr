...
public enum ProcessResultEnum {
	...
	UPDATE_SUCCESS(ProcessStatus.SUCCESS, "APP-001-004","更新成功"),
	UPDATE_FAIL(ProcessStatus.FAIL, "APP-001-005", "更新失敗"),
	INSERT_SUCCESS(ProcessStatus.SUCCESS, "APP-001-006","新增成功");
